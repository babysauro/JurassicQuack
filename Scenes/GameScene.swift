...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        let songList = ["track1.mp3", "track2.mp3", "track3.mp3", "track4.mp3",
                        "track5.mp3", "track6.mp3", "track7.mp3", "track8.mp3",
                        "track9.mp3"]
...
extension GameScene {
    ...
    func moveCamera(){
        ...
        //tentativo allah akbar
        
        let timer = Timer(timeInterval: 1.0, repeats: true){ timer in
            self.cameraMovePointPerSecond += 10 }
        //Background
    ...
    //Check that the player touches the left screen border
...
extension GameScene: SKPhysicsContactDelegate {
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        case PhysicsCategory.Block:
            cameraMovePointPerSecond += 100.0 //Increasing the movement speed of Camera
            numScore -= 1
        ...
        case PhysicsCategory.Coin:
            if let node = other.node {
                ...
                if numScore > highscore {
                    ...
                    ScoreGenerator.sharedInstance.setScore(numScore) //highscore
                } else {
